(() => {
  ...
  const gradingRules = {
    ...
    rq038: { accepts: ["six months", "6 months"] },
    rq039: { accepts: ["50 million", "£50 million", "50m", "about 50 million"] },
    ...
    rq044: { groups: [["single tier", "one tier"], ["55"]], minimumGroups: 2 },
    rq046: { accepts: ["54", "54 percent", "fifty four percent"] },
    rq048: { accepts: ["5 6 percent", "5 to 6 percent", "about 5 percent", "about 6 percent", "5 percent", "6 percent"] },
    rq050: { groups: [["offices"], ["supermarket"]], minimumGroups: 2 },
    rq052: { accepts: ["lanark county buildings", "south lanarkshire council headquarters"] },
    ...
    rq059: { accepts: ["sent to his majesty", "sent to the king", "goes to the crown", "paid to the crown", "hm treasury", "the treasury"] },
